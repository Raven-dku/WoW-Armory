...
<div class="paperdoll-model" style="height: 600px; width: 100%;">
	<object width="100%" height="100%" type="application/x-shockwave-flash" data="ZAMviewerfp11.swf" width="100%" height="100%" id="paperdoll-model-paperdoll-0-equipment-set">
